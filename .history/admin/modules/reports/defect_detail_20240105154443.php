 ...
 * 3: userId là người ngoài (thực hiện cho chức năng seen all ở permissions)
 */
$statusSign = 3; 
if(($userId == $userXX->user_id && $userXX->user_id == 2) || ($userId == $userQD->user_id && $userQD->user_id == 2) || ($userId == $userPD->user_id && $userPD->user_id == 2)) {
   $statusSign = 2;
}
