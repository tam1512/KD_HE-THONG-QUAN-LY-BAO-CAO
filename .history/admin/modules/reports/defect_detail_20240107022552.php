...
$userGC = json_decode($report["userPD"]);
...
<div class="container content-pdf">
   ...
   <div>
      ...
      <!-- Signature -->
      <div id="sign_GC"></div>
      <small class="errors" id="errors_sign_GC"></small>
      <br>
      ...
      <small class="errors" id="errors_fullname_GC"></small>
      ...
      <input type="hidden" name="sign_text" id="sign-text_GC">
   </div>
   <br>
</div>
