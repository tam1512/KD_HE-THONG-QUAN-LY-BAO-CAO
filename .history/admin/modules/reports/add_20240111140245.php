...
$signText = firstRaw("SELECT sign_text FROM sign WHERE user_id = $userId");
 ...
 if(isPost()) {
   ...
   $arrCodeReport = explode("/", $codeReport);

   if(empty($arrCodeReport[1])) {
      $errors['code_report']['required'] = 'Phân xưởng không được bỏ trống';
   }
   if(empty($factoryId)) {
            ...
            <div class="row">
               <div class="col-6">
                  <div class="form-group">
                     ...
                     <input type="text" id="PX" class="form-control" placeholder="Phân xưởng..."
