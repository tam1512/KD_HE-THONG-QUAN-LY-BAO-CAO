      ...
      <table class="table table-bordered">
         ...
         <tbody>
            ...
            <tr>
               ...
               echo $status == 1 ? '<span class="badge badge-success">Đã ký</span>' : '<a class="btn btn-danger" href="'.getLinkAdmin('users', 'quick_sign', ["report_id" => $report['id'], "page" => $page]).'">Ký ngay</a>'?>
               </td>
