...
<div class="container content-pdf">
      ...
      <tbody>
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2" width="40%">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Tên cơ sở:</b>
               <p style="display: inline;<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
                  <?php echo $report['factory_name'] ?></p>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2" width="60%">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Tên sản phẩm:</b>
               <p style="display: inline; <?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Người phát hiện:</b>
               <p style="display: inline; <?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
                  <?php echo $report['defect_finder'] ?></p>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Số Po/Lot:</b>
               <p style="display: inline; <?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Số lượng giao:</b>
               <p style="display: inline; <?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
                  <?php echo $report['quantity_deliver'] ?></p>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2">
               <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Số lượng kiểm:</b>
               <p style="display: inline; <?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> rowspan="4" width="13%"
               style="text-align: left; vertical-align: middle;"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Kết quả
                  AQL</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="21%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">AQL 2.5-4.0
                  Level II</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="19.5%" class="text-center"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Số lỗi tối đa
                  cho phép</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> class="text-center" width="27.54%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Số lỗi thực
                  tế</b></td>
         </tr>
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nghiêm trọng</b></td>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nặng</b></td>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nhẹ</b></td>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>">
   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="6%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : "" ?>">STT</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="50%" colspan="2"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nội dung lỗi</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="11%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Mức độ</b>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="13%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nghiêm
                  trọng</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="8%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Lỗi nặng</b>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="8%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Lỗi nhẹ</b>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
               <?php echo (!empty($actionOld)) ? 'colspan="2"' : false; ?>><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Ghi
                  chú</b></td>
      ...
      <tbody>
         ...
         <tr>
            ...
            if($isFirst) {
               if($isStyle) {
                  echo '<td class="text-center" style="vertical-align: middle; padding: 0.50rem 0.60rem; font-size: 10px; '.$styleFont.'"
            ...
            if($isFirst) {
               if($isStyle) {
                  echo '<td 
                  rowspan="'.$countRows.'" style="text-align: center; vertical-align: middle;padding: 0.50rem 0.60rem;'.$styleFont.'"
                  width="10%">'.$key.'</td>';
               } else {
                  echo '<td 
            ...
            ?>
            <td width="26%"
               style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>">
            ...
            <td style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>"
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="3" class="text-center"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Tổng cộng</b>
            </td>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>">
            </td>
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Kết luận:</b>
            </td>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px; padding: 0.50rem 0.60rem;" : ""   ?>"><i
   ...
   <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Nhận xét/Yêu cầu của QC:</b>
   <p style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
      <?php echo (!empty($report['comment'])) ? $report['comment'] : '............................................................................................................................................................................................................................................................................................................................................' ?>
   </p>

   <b style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Hướng xử lý (Đối với trường hợp không
      đạt):</b>
   <p id="content_suggest" style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">
      <?php 
   ...
   <table class="table">
      <tr>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="20%" class="text-center"><b
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Người kiểm tra</b>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="20%" class="text-center"><b
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Công sở gia
               công</b></td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="20%" class="text-center"><b
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Người xem xét</b>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="20%" class="text-center"><b
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">QĐ/PQĐ</b></td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="20%" class="text-center"><b
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : ""   ?>">Người phê duyệt</b>
         </td>
      </tr>
      <!-- Thêm chữ ký đã xác nhận ký -->
      <tr>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>>
            <?php echo !empty($sign_userKT) ? '<img src="'.$sign_userKT.'" alt="" class="sign"><p class="d-block text-center mt-2" style="'.$styleFont.'">'.$fullnameUserKT.'</p><p class="d-block text-center" style="'.$styleFont.'">'.getDateFormat($report['create_at'], 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> id="sign_GC_content">
            <?php echo !empty($sign_text_GC) ? '<img src="'.$sign_text_GC.'" alt="" class="sign"><p class="d-block text-center mt-2" style="'.$styleFont.'">'.$fullnameGC.'
            </p>
            <p class="d-block text-center" style="'.$styleFont.'">'.getDateFormat($sign_at_GC, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>>
            <?php echo !empty($sign_userXX) && $status_userXX == 1 ? '<img src="'.$sign_userXX.'" alt="" class="sign"><p class="d-block text-center mt-2" style="'.$styleFont.'">'.$fullnameUserXX.'
            </p>
            <p class="d-block text-center" style="'.$styleFont.'">'.getDateFormat($userXX->sign_at, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>>
            <?php echo !empty($sign_userQD) && $status_userQD == 1 ? '<img src="'.$sign_userQD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="'.$styleFont.'">'.$fullnameUserQD.'
            </p>
            <p class="d-block text-center" style="'.$styleFont.'">'.getDateFormat($userQD->sign_at, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>>
            <?php echo !empty($sign_userPD) && $status_userPD == 1 ? '<img src="'.$sign_userPD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="'.$styleFont.'">'.$fullnameUserPD.'
            </p>
