      ...
      <tbody>
         <tr>
            ...
            <td width="50%" style="text-align: center; vertical-align: middle;">
               <h2 class="flex-1 text-center" style="<?php echo $styleFont ?>; font-size: 16px">BIÊN BẢN KIỂM TRA
                  CHẤT LƯỢNG MAY ĐẦU VÀO</h2>
            </td>
            <td width="30%">
               <p class="mb-0" style="<?php echo $styleFont ?>; font-size: 10px">Số hiệu: BBKTCL-BM01</p>
