...
// echo "</pre>";
 ...
 if(isPost()) {
   ...
   if(empty($errors)) {
      ...
      $notification = firstRaw("SELECT * FROM notificatios WHERE report_id = $reportId");
      ...
      if($userXXSign->user_id == $userXXId) {
         ...
         $dataUpdateReportNoti["userXX"] = '{"user_id":'.$userXXId.', "seen":2, "sign":2}';
      }
      if($userQDSign->user_id == $userQDId) {
         ...
         $dataUpdateReportNoti["userQD"] = '{"user_id":'.$userQDId.', "seen":2, "sign":2}';
      }
      if($userPDSign->user_id == $userPDId) {
         ...
         $dataUpdateReportNoti["userPD"] = '{"user_id":'.$userPDId.', "seen":2, "sign":2}';
      }
