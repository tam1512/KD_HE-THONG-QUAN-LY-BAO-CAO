   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="6%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : "" ?>">STT</b></td>
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="11%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Mức độ</b>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="13%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nghiêm
                  trọng</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="8%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Lỗi nặng</b>
            </td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="8%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Lỗi nhẹ</b>
            </td>
      ...
      <tbody>
         ...
         <tr>
            ...
            if($isFirst) {
               if($isStyle) {
                  echo '<td class="text-center" style="vertical-align: middle; padding: 0.50rem 0.60rem; '.$styleFont.'"
            ...
            echo ($isFirst) ? '<td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
            class="text-center" style="vertical-align: middle; '.$styleFont.'"
            rowspan="'.$countRows.'">'.$count.'</td>' : ''
            ?>
            <?php echo ($isFirst) ? '<td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
            rowspan="'.$countRows.'" style="text-align: center; vertical-align: middle;'.$styleFont.'"
            width="10%">'.$key.'</td>' : ''; $isFirst = false?>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="26%"
               style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php echo $item['name'] ?></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> class="text-center"
               style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php 
               $level =  $item['level'];
               echo $level;
            ...
            <?php
               if(empty($actionOld)) {
                  echo '<td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>><a
         ...
         <tr>
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> class="text-center"
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> class="text-center"
               ...
               <?php echo $resultAQL['quantity_light_real'] ?></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
               <?php echo (!empty($actionOld)) ? 'colspan="2"' : false; ?>></td>
         </tr>
         <tr>
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2" class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><i
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"
                  class="far <?php echo ($resultAQL['conclusion'] == 1) ? 'fa-check-square' : 'fa-square' ?> mr-2"></i>KHÔNG
               ĐẠT</td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
               <?php echo (!empty($actionOld)) ? 'colspan="4"' : 'colspan="3"'; ?> class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><i
