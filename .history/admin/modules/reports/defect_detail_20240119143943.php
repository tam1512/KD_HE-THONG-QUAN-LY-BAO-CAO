...
<div class="container content-pdf">
         ...
         <tr>
            <td width="8%">
               <img
                  ...
                  alt="logo" <?php echo $isStyle ? 'width="200" height="100"' : 'width="150" height="50"' ?>>
            </td>
            ...
            <td width="30%">
               <p class="mb-0" style="<?php echo $styleFont; echo $isStyle ? "font-size: 8px" : "" ?>">Số hiệu:
                  BBKTCL-BM01</p>
               <p class="mb-0" style="<?php echo $styleFont; echo $isStyle ? "font-size: 8px" : ""  ?>">Ngày hiệu lực:
                  15/03/2023</p>
               <p class="mb-0" style="<?php echo $styleFont; echo $isStyle ? "font-size: 8px" : ""  ?>">Lần ban hành:
                  01</p>
            </td>
         </tr>
         <tr>
      ...
      <tbody>
         ...
         <tr>
            <td rowspan="4" width="13%" style="text-align: left; vertical-align: middle;"><b
                  ...
                  AQL</b></td>
            <td width="21%"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">AQL 2.5-4.0
                  Level II</b></td>
            <td width="19.5%" class="text-center"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Số lỗi tối đa
                  cho phép</b></td>
            <td class="text-center" width="27.54%"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Số lỗi thực
                  tế</b></td>
         </tr>
         <tr>
            <td><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nghiêm trọng</b></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php echo $resultAQL['quantity_serious_accept'] ?></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
         </tr>
         <tr>
            <td><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nặng</b></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
         ...
         <tr>
            <td><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nhẹ</b></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td width="6%" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><b>STT</b></td>
            <td width="50%" colspan="2"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nội dung lỗi</b></td>
            <td width="11%"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Mức độ</b>
            </td>
            <td width="13%"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Nghiêm
                  trọng</b></td>
            <td width="8%"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Lỗi nặng</b>
            </td>
            <td width="8%"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Lỗi nhẹ</b>
            </td>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td width="26%"
               style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
            ...
            <td style="vertical-align: middle; <?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"
         ...
         <tr>
            ...
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">
               <?php echo $resultAQL['quantity_heavy_real'] ?></td>
         ...
         <tr>
            <td colspan="2"><b style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Kết luận:</b>
            </td>
            <td class="text-center" style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><i
                  class="far <?php echo ($resultAQL['conclusion'] == 2) ? 'fa-check-square' : 'fa-square' ?> mr-2"></i>ĐẠT
            </td>
            <td colspan="2" class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><i
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"
   ...
   <table class="table">
      <tr>
         <td width="20%" class="text-center"><b
