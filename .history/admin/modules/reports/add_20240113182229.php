 ...
 if(isPost()) {
   ...
   if(empty($errors)) {
      ...
      if($statusInsertReport) {
         ...
         $userXXNoti = '{"user_id":'.$userXXId.', "seen":2, "sign":2, "show": 1, "create_at":"'.date('d-m-Y H:i:s').'"}';
         $userQDNoti = '{"user_id":'.$userQDId.', "seen":2, "sign":2, "show": 1, "create_at":"'.date('d-m-Y H:i:s').'"}';
         $userKTNoti = '{"user_id":'.$userId.', "seen":2, "sign":1, "show": 1, "create_at":"'.date('d-m-Y H:i:s').'"}';
         $dataInsertNoti = [
            'report_id' => $reportId,
            'code_report' => $codeReport,
            "userXX" => $userXXNoti,
