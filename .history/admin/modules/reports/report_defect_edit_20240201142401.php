                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <a class="btn btn-success" href="
                                                                <?php
                                                                   echo getLinkAdmin('reports', 'edit', ['id' => $reportId]).'?defect_id='.$defectId.'&report_defect_note='.$reportDefectNote.'cate_defect_id='.$defectCategory['id']
                                                                ?>">
                                                Chọn
                                             </a>
                                          </td>
                                    ...
                                    <tbody id="content_modal">
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <a class="btn btn-success" href="
                                                                <?php
                                                                   echo getLinkAdmin('reports', 'report_defect_edit', ['id' => $reportId]).'?defect_id='.$defect['id'].'&cate_defect_note='.$reportDefectNote.'&cate_defect_id='.$cateDefectId
                                                                ?>">
                                                Chọn
                                             </a>
                                          </td>
