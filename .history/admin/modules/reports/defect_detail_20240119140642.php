...
<div class="container content-pdf">
      ...
      <tbody>
         <tr>
            ...
            <td width="50%" style="text-align: center; vertical-align: middle;">
               <h2 class="flex-1 text-center" style="font-family: latha, DejaVu Sans, sans-serif;">BIÊN BẢN KIỂM TRA
                  CHẤT LƯỢNG MAY ĐẦU VÀO</h2>
            </td>
            <td width="30%">
               <p class="mb-0" style="font-family: latha, DejaVu Sans, sans-serif;">Số hiệu: BBKTCL-BM01</p>
               <p class="mb-0" style="font-family: latha, DejaVu Sans, sans-serif;">Ngày hiệu lực: 15/03/2023</p>
               <p class="mb-0" style="font-family: latha, DejaVu Sans, sans-serif;">Lần ban hành: 01</p>
            </td>
         </tr>
         <tr>
            <td colspan=2>
               <p style="font-family: latha, DejaVu Sans, sans-serif;">Số: <?php echo $report['code_report'] ?></p>
            </td>
            <td width="30%">
               <p style="font-family: latha, DejaVu Sans, sans-serif;">
      ...
      <tbody>
         <tr>
            <td colspan="2" width="40%">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Tên cơ sở:</b>
               <p style="display: inline;font-family: latha, DejaVu Sans, sans-serif;">
                  <?php echo $report['factory_name'] ?></p>
            </td>
            <td colspan="2" width="60%">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Tên sản phẩm:</b>
               <p style="display: inline; font-family: latha, DejaVu Sans, sans-serif;">
         ...
         <tr>
            <td colspan="2">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Người phát hiện:</b>
               <p style="display: inline; font-family: latha, DejaVu Sans, sans-serif;">
                  <?php echo $report['defect_finder'] ?></p>
            </td>
            <td colspan="2">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Số Po/Lot:</b>
               <p style="display: inline; font-family: latha, DejaVu Sans, sans-serif;"><?php echo $report['po_code'] ?>
               </p>
            </td>
         </tr>
         <tr>
            <td colspan="2">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Số lượng giao:</b>
               <p style="display: inline; font-family: latha, DejaVu Sans, sans-serif;">
                  <?php echo $report['quantity_deliver'] ?></p>
            </td>
            <td colspan="2">
               <b style="font-family: latha, DejaVu Sans, sans-serif;">Số lượng kiểm:</b>
               <p style="display: inline; font-family: latha, DejaVu Sans, sans-serif;">
                  <?php echo $report['quantity_inspect'] ?></p>
            </td>
         </tr>
         <tr>
            <td rowspan="4" width="13%" style="text-align: left; vertical-align: middle;"><b
                  style="font-family: latha, DejaVu Sans, sans-serif;">Kết quả AQL</b></td>
            <td width="21%"><b style="font-family: latha, DejaVu Sans, sans-serif;">AQL 2.5-4.0 Level II</b></td>
            <td width="19.5%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Số lỗi tối đa
                  cho phép</b></td>
            <td class="text-center" width="27.54%"><b style="font-family: latha, DejaVu Sans, sans-serif;">Số lỗi thực
                  tế</b></td>
         </tr>
         <tr>
            <td><b style="font-family: latha, DejaVu Sans, sans-serif;">Nghiêm trọng</b></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
               <?php echo $resultAQL['quantity_serious_accept'] ?></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
         </tr>
         <tr>
            <td><b style="font-family: latha, DejaVu Sans, sans-serif;">Nặng</b></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
         ...
         <tr>
            <td><b style="font-family: latha, DejaVu Sans, sans-serif;">Nhẹ</b></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td width="6%" style="font-family: latha, DejaVu Sans, sans-serif;"><b>STT</b></td>
            <td width="50%" colspan="2"><b style="font-family: latha, DejaVu Sans, sans-serif;">Nội dung lỗi</b></td>
            <td width="11%"><b style="font-family: latha, DejaVu Sans, sans-serif;">Mức độ</b></td>
            <td width="13%"><b style="font-family: latha, DejaVu Sans, sans-serif;">Nghiêm trọng</b></td>
            <td width="8%"><b style="font-family: latha, DejaVu Sans, sans-serif;">Lỗi nặng</b></td>
            <td width="8%"><b style="font-family: latha, DejaVu Sans, sans-serif;">Lỗi nhẹ</b></td>
            <td <?php echo (!empty($actionOld)) ? 'colspan="2"' : false; ?>><b
                  style="font-family: latha, DejaVu Sans, sans-serif;">Ghi chú</b></td>
            <?php echo (empty($actionOld)) ? '<td width="5%" style="font-family: latha, DejaVu Sans, sans-serif;"><b>Ảnh</b></td>' : false; ?>
         </tr>
      </thead>
      <tbody>
         <?php 
         ...
         ?>
         <tr>
            <?php echo ($isFirst) ? '<td class="text-center" style="vertical-align: middle; font-family: latha, DejaVu Sans, sans-serif;" rowspan="'.$countRows.'">'.$count.'</td>' : '' ?>
            <?php echo ($isFirst) ? '<td rowspan="'.$countRows.'" style="text-align: center; vertical-align: middle; font-family: latha, DejaVu Sans, sans-serif;" width="10%">'.$key.'</td>' : '';  $isFirst = false?>
            <td width="26%" style="vertical-align: middle; font-family: latha, DejaVu Sans, sans-serif;">
               <?php echo $item['name'] ?></td>
            <td class="text-center" style="vertical-align: middle; font-family: latha, DejaVu Sans, sans-serif;">
               <?php 
               $level =  $item['level'];
               echo $level;
               ?>
            ...
            <td style="vertical-align: middle; font-family: latha, DejaVu Sans, sans-serif;"
         ...
         ?>
         <tr>
            <td colspan="3" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Tổng cộng</b>
            </td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;"></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;">
               <?php echo $resultAQL['quantity_heavy_real'] ?></td>
         ...
         <tr>
            ...
            <td class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;"><i
                  class="far <?php echo ($resultAQL['conclusion'] == 2) ? 'fa-check-square' : 'fa-square' ?> mr-2"></i>ĐẠT
            </td>
            <td colspan="2" class="text-center" style="font-family: latha, DejaVu Sans, sans-serif;"><i
            ...
            <td <?php echo (!empty($actionOld)) ? 'colspan="4"' : 'colspan="3"'; ?> class="text-center"
               style="font-family: latha, DejaVu Sans, sans-serif;"><i
   ...
   <b style="font-family: latha, DejaVu Sans, sans-serif;">Nhận xét/Yêu cầu của QC:</b>
   <p style="font-family: latha, DejaVu Sans, sans-serif;">
      <?php echo (!empty($report['comment'])) ? $report['comment'] : '............................................................................................................................................................................................................................................................................................................................................' ?>
   </p>

   <b style="font-family: latha, DejaVu Sans, sans-serif;">Hướng xử lý (Đối với trường hợp không đạt):</b>
   <p id="content_suggest" style="font-family: latha, DejaVu Sans, sans-serif;">
      <?php 
   ...
   <table class="table">
      <tr>
         <td width="20%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Người kiểm tra</b>
         </td>
         <td width="20%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Công sở gia
               công</b></td>
         <td width="20%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Người xem xét</b>
         </td>
         <td width="20%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">QĐ/PQĐ</b></td>
         <td width="20%" class="text-center"><b style="font-family: latha, DejaVu Sans, sans-serif;">Người phê duyệt</b>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td id="sign_GC_content">
            <?php echo !empty($sign_text_GC) ? '<img src="'.$sign_text_GC.'" alt="" class="sign"><p class="d-block text-center mt-2" style="font-family: latha, DejaVu Sans, sans-serif;">'.$fullnameGC.'</p><p class="d-block text-center" style="font-family: latha, DejaVu Sans, sans-serif;">'.getDateFormat($sign_at_GC, 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userXX) && $status_userXX == 1 ? '<img src="'.$sign_userXX.'" alt="" class="sign"><p class="d-block text-center mt-2" style="font-family: latha, DejaVu Sans, sans-serif;">'.$fullnameUserXX.'</p><p class="d-block text-center" style="font-family: latha, DejaVu Sans, sans-serif;">'.getDateFormat($userXX->sign_at, 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userQD) && $status_userQD == 1 ? '<img src="'.$sign_userQD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="font-family: latha, DejaVu Sans, sans-serif;">'.$fullnameUserQD.'</p><p class="d-block text-center" style="font-family: latha, DejaVu Sans, sans-serif;">'.getDateFormat($userQD->sign_at, 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userPD) && $status_userPD == 1 ? '<img src="'.$sign_userPD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="font-family: latha, DejaVu Sans, sans-serif;">'.$fullnameUserPD.'</p><p class="d-block text-center" style="font-family: latha, DejaVu Sans, sans-serif;">'.getDateFormat($userPD->sign_at, 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
      </tr>
   </table>
   <?php 
