...
<div class="container content-pdf">
   <table class="table table-bordered mb-0">
      <tbody>
         <tr>
            ...
            <td width="50%" style="text-align: center; vertical-align: middle; font-size:16px">
   ...
   <table class="table table-bordered">
      ...
      <tbody>
         ...
         ?>
         <tr>
            <?php echo ($isFirst) ? '<td class="text-center" style="vertical-align: middle; '.$styleFont.'"
            rowspan="'.$countRows.'">'.$count.'</td>' : '' ?>
            <?php echo ($isFirst) ? '<td rowspan="'.$countRows.'" style="text-align: center; vertical-align: middle;'.$styleFont.'"
         ...
         <tr>
            <td colspan="2"><b style="<?php echo $styleFont ?>">Kết luận:</b></td>
            ...
            <td colspan="2" class="text-center" style="<?php echo $styleFont ?>"><i style="<?php echo $styleFont ?>"
