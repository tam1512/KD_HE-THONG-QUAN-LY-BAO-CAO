                  ...
                  <div class="col-4">
                     <div class="form-group">
                        ...
                        <div class="row ckfinder-group">
                           <div class="col-9">
                              <textarea type="text" id="images_defect" name="images_defect"
                                 class="form-control image-link" placeholder="Đường dẫn ảnh..."
                                 disabled><?php echo old('images_defect', $old) ?></textarea>
                              <?php echo form_error('images_defect', $errors, '<span class="error">', '</span>') ?>
                           </div>
                           <div class="col-3">
                              <button type="button" class="btn btn-success btn-block ckfinder-choose-image"><i
