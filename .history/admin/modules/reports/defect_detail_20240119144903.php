   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="6%"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>"><b>STT</b></td>
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
               <?php echo (!empty($actionOld)) ? 'colspan="2"' : false; ?>><b
                  ...
                  chú</b></td>
            <?php echo (empty($actionOld)) ? '<td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?>
            width="5%" style="'.$styleFont.'"><b>Ảnh</b></td>' : false;
            ?>
         </tr>
      </thead>
      <tbody>
