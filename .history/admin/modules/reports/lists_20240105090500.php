      ...
      <table class="table table-bordered">
         ...
         <tbody>
               ...
               if(!empty($listReportOnPage)):
                  ...
                  foreach($listReportOnPage as $report):
                     ...
                     if($report['user_id'] == $user_id) {
                        ...
                        if($userXX->user_id == $user_id) {
                           $status = $userXX->user_id == 1;
                        }

                        if($userQD->user_id == $user_id) {
                           $status = $userQD->user_id == 1;
                        }

                        if($userPD->user_id == $user_id) {
                           $status = $userPD->user_id == 1;
                        }
                     }
            ...
            <tr>
               ...
               <td><?php echo $report['po_code'] ."<br>" . $status ?></td>
