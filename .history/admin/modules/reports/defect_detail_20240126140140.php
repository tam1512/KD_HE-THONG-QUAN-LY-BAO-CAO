         ...
         <tr>
            ...
            <td class="text-center"
               ...
               <img
                  ...
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;" class="mr-2 mt-2">ĐẠT
            </td>
            <td colspan="2" class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px; padding: 0.50rem 0.60rem;" : ""   ?>">
               <img
                  src="<?php echo "data:image/png;base64,".base64_encode(file_get_contents(_WEB_HOST_ROOT_ADMIN."/images/$imgNotAchieve")) ?>"
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;" class="mr-2 mt-2">KHÔNG
               ĐẠT
            </td>
            <td <?php echo (!empty($actionOld)) ? 'colspan="4"' : 'colspan="3"'; ?> class="text-center"
               ...
               <img
                  ...
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;" class="mr-2 mt-2">CHỜ
               XỬ LÝ
            </td>
         </tr>
      </tbody>
