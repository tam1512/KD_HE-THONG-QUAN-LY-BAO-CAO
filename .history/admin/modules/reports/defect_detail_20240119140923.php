...
<div class="container content-pdf">
      ...
      <tbody>
         <tr>
            ...
            <td width="50%" style="text-align: center; vertical-align: middle;">
               <h2 class="flex-1 text-center" style="<?php echo $styleFont ?>">BIÊN BẢN KIỂM TRA
                  CHẤT LƯỢNG MAY ĐẦU VÀO</h2>
            </td>
            <td width="30%">
               <p class="mb-0" style="<?php echo $styleFont ?>">Số hiệu: BBKTCL-BM01</p>
               <p class="mb-0" style="<?php echo $styleFont ?>">Ngày hiệu lực: 15/03/2023</p>
               <p class="mb-0" style="<?php echo $styleFont ?>">Lần ban hành: 01</p>
            </td>
         </tr>
         <tr>
            <td colspan=2>
               <p style="<?php echo $styleFont ?>">Số: <?php echo $report['code_report'] ?></p>
            </td>
            <td width="30%">
               <p style="<?php echo $styleFont ?>">
      ...
      <tbody>
         <tr>
            <td colspan="2" width="40%">
               <b style="<?php echo $styleFont ?>">Tên cơ sở:</b>
               <p style="display: inline;<?php echo $styleFont ?>">
                  <?php echo $report['factory_name'] ?></p>
            </td>
            <td colspan="2" width="60%">
               <b style="<?php echo $styleFont ?>">Tên sản phẩm:</b>
               <p style="display: inline; <?php echo $styleFont ?>">
         ...
         <tr>
            <td colspan="2">
               <b style="<?php echo $styleFont ?>">Người phát hiện:</b>
               <p style="display: inline; <?php echo $styleFont ?>">
                  <?php echo $report['defect_finder'] ?></p>
            </td>
            <td colspan="2">
               <b style="<?php echo $styleFont ?>">Số Po/Lot:</b>
               <p style="display: inline; <?php echo $styleFont ?>"><?php echo $report['po_code'] ?>
               </p>
            </td>
         </tr>
         <tr>
            <td colspan="2">
               <b style="<?php echo $styleFont ?>">Số lượng giao:</b>
               <p style="display: inline; <?php echo $styleFont ?>">
                  <?php echo $report['quantity_deliver'] ?></p>
            </td>
            <td colspan="2">
               <b style="<?php echo $styleFont ?>">Số lượng kiểm:</b>
               <p style="display: inline; <?php echo $styleFont ?>">
         ...
         <tr>
            <td rowspan="4" width="13%" style="text-align: left; vertical-align: middle;"><b
                  style="<?php echo $styleFont ?>">Kết quả
                  AQL</b></td>
            <td width="21%"><b style="<?php echo $styleFont ?>">AQL 2.5-4.0 Level II</b></td>
            <td width="19.5%" class="text-center"><b style="<?php echo $styleFont ?>">Số lỗi tối đa
                  cho phép</b></td>
            <td class="text-center" width="27.54%"><b style="<?php echo $styleFont ?>">Số lỗi thực
                  tế</b></td>
         </tr>
         <tr>
            <td><b style="<?php echo $styleFont ?>">Nghiêm trọng</b></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
               <?php echo $resultAQL['quantity_serious_accept'] ?></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
         </tr>
         <tr>
            <td><b style="<?php echo $styleFont ?>">Nặng</b></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
         ...
         <tr>
            <td><b style="<?php echo $styleFont ?>">Nhẹ</b></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
   ...
   <table class="table table-bordered">
      <thead>
         <tr class="text-center">
            <td width="6%" style="<?php echo $styleFont ?>"><b>STT</b></td>
            <td width="50%" colspan="2"><b style="<?php echo $styleFont ?>">Nội dung lỗi</b></td>
            <td width="11%"><b style="<?php echo $styleFont ?>">Mức độ</b></td>
            <td width="13%"><b style="<?php echo $styleFont ?>">Nghiêm trọng</b></td>
            <td width="8%"><b style="<?php echo $styleFont ?>">Lỗi nặng</b></td>
            <td width="8%"><b style="<?php echo $styleFont ?>">Lỗi nhẹ</b></td>
            <td <?php echo (!empty($actionOld)) ? 'colspan="2"' : false; ?>><b style="<?php echo $styleFont ?>">Ghi
                  chú</b></td>
            <?php echo (empty($actionOld)) ? '<td width="5%" style="<?php echo $styleFont ?>"><b>Ảnh</b></td>' : false;
            ?>
         </tr>
      </thead>
      <tbody>
         ...
         ?>
         <tr>
            <?php echo ($isFirst) ? '<td class="text-center" style="vertical-align: middle; <?php echo $styleFont ?>"
            rowspan="'.$countRows.'">'.$count.'</td>' : '' ?>
            <?php echo ($isFirst) ? '<td rowspan="'.$countRows.'" style="text-align: center; vertical-align: middle; <?php echo $styleFont ?>"
            width="10%">'.$key.'</td>' : ''; $isFirst = false?>
            <td width="26%" style="vertical-align: middle; <?php echo $styleFont ?>">
               <?php echo $item['name'] ?></td>
            <td class="text-center" style="vertical-align: middle; <?php echo $styleFont ?>">
               <?php 
               $level =  $item['level'];
               echo $level;
               ?>
            ...
            <td style="vertical-align: middle; <?php echo $styleFont ?>"
         ...
         ?>
         <tr>
            <td colspan="3" class="text-center"><b style="<?php echo $styleFont ?>">Tổng cộng</b>
            </td>
            <td class="text-center" style="<?php echo $styleFont ?>"></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
               <?php echo $resultAQL['quantity_serious_real'] ?></td>
            <td class="text-center" style="<?php echo $styleFont ?>">
               <?php echo $resultAQL['quantity_heavy_real'] ?></td>
         ...
         <tr>
            ...
            <td class="text-center" style="<?php echo $styleFont ?>"><i
                  class="far <?php echo ($resultAQL['conclusion'] == 2) ? 'fa-check-square' : 'fa-square' ?> mr-2"></i>ĐẠT
            </td>
            <td colspan="2" class="text-center" style="<?php echo $styleFont ?>"><i
   ...
   <b style="<?php echo $styleFont ?>">Nhận xét/Yêu cầu của QC:</b>
   <p style="<?php echo $styleFont ?>">
      <?php echo (!empty($report['comment'])) ? $report['comment'] : '............................................................................................................................................................................................................................................................................................................................................' ?>
   </p>

   <b style="<?php echo $styleFont ?>">Hướng xử lý (Đối với trường hợp không đạt):</b>
   <p id="content_suggest" style="<?php echo $styleFont ?>">
      <?php 
   ...
   <table class="table">
      <tr>
         <td width="20%" class="text-center"><b style="<?php echo $styleFont ?>">Người kiểm tra</b>
         </td>
         <td width="20%" class="text-center"><b style="<?php echo $styleFont ?>">Công sở gia
               công</b></td>
         <td width="20%" class="text-center"><b style="<?php echo $styleFont ?>">Người xem xét</b>
         </td>
         <td width="20%" class="text-center"><b style="<?php echo $styleFont ?>">QĐ/PQĐ</b></td>
         <td width="20%" class="text-center"><b style="<?php echo $styleFont ?>">Người phê duyệt</b>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td id="sign_GC_content">
            <?php echo !empty($sign_text_GC) ? '<img src="'.$sign_text_GC.'" alt="" class="sign"><p class="d-block text-center mt-2" style="<?php echo $styleFont ?>">'.$fullnameGC.'
            </p>
            <p class="d-block text-center" style="<?php echo $styleFont ?>">'.getDateFormat($sign_at_GC, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userXX) && $status_userXX == 1 ? '<img src="'.$sign_userXX.'" alt="" class="sign"><p class="d-block text-center mt-2" style="<?php echo $styleFont ?>">'.$fullnameUserXX.'
            </p>
            <p class="d-block text-center" style="<?php echo $styleFont ?>">'.getDateFormat($userXX->sign_at, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userQD) && $status_userQD == 1 ? '<img src="'.$sign_userQD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="<?php echo $styleFont ?>">'.$fullnameUserQD.'
            </p>
            <p class="d-block text-center" style="<?php echo $styleFont ?>">'.getDateFormat($userQD->sign_at, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
         <td>
            <?php echo !empty($sign_userPD) && $status_userPD == 1 ? '<img src="'.$sign_userPD.'" alt="" class="sign"><p class="d-block text-center mt-2" style="<?php echo $styleFont ?>">'.$fullnameUserPD.'
            </p>
            <p class="d-block text-center" style="<?php echo $styleFont ?>">'.getDateFormat($userPD->sign_at, 'd-m-Y
               H:i:s').'</p>' : false ?>
         </td>
      </tr>
   </table>
