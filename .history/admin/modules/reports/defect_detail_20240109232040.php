...
<div class="container content-pdf">
   ...
   <div class="form-group">
      ...
      <select name="status" id="chang_status" class="form-control">
         ...
         <option value="2" <?php echo ($report['status'] == 2) ? 'checked' : false ?>>Chấp nhận</option>
         <option value="3" <?php echo ($report['status'] == 3) ? 'checked' : false ?>>Trả sửa</option>
         <option value="4" <?php echo ($report['status'] == 4) ? 'checked' : false ?>>Nhận tiền trừ</option>
      </select>
   </div>
   <div class="form-group">
