...
if(!empty($actionOld)):
   if(!empty($listAllImages)): 
      $isFirst = true;
?>
<div class="container-fluid content-pdf page-break-image" style="padding: 20px">
...
?>
      <div class="mt-3 mr-2" style="display: inline-block; margin-right: 5px">
         <img src="<?php echo "data:image/png;base64,".base64_encode(file_get_contents($item['image_link'])) ?>" alt=""
            style="width:250px; height: 250px; object-fit:container;" class="mr-2 mt-2">
      </div>
      <?php 
      endforeach;
      ?>
