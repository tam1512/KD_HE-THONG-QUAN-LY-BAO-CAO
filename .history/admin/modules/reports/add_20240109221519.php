               ...
               <div class="col-12 row">
                  <div class="col-4 d-flex">
                     <div class="form-group flex-1">
                        ...
                        <div class="d-flex">
                           <select name="cate_defect" id="cate_defect" class="form-control mw-210 selectpicker"
                              data-live-search="true" data-title="Categories Defect" data-width="100%">
                              <?php 
                     ...
                     <div class="form-group flex-1">
                        ...
                        <div class="d-flex">
                           <select name="defect" id="defect" class="form-control mw-210 selectpicker"
                              data-live-search="true" data-title="Defect" data-width="100%">
                              <?php 
