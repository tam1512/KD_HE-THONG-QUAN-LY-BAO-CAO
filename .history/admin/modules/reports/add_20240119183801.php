               ...
               if($statusInsertReportDefect) {
                  if(!empty($itemAdd['files'])) {
                     ...
                     foreach($itemAdd['files'] as $file) {
                        $dataInsertImage = [
                           'image_link' => 'http://localhost'.$file,
                     ...
                     ?>
                        <tr>
                           ...
                           <td>
                              ...
                              <?php 
                                 echo !empty($reportId) ? getLinkAdmin('reports', 'seen_images_report_defect', ['report_id'=>$reportId, 'key'=>$key]) : getLinkAdmin('reports', 'seen_images_report_defect', ['report_id'=>"null", 'key'=>$key]); 
                              ?>">
                           ...
                           <td>
                              ...
                              <?php 
                                 echo !empty($reportId) ? getLinkAdmin('reports', 'report_defect_delete', ['key'=>$key, 'report_id'=>$reportId])  : getLinkAdmin('reports', 'report_defect_delete', ['key'=>$key, 'report_id'=>"null"]) 
