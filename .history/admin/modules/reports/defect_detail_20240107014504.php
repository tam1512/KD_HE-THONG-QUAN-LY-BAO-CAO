...
<div class="container content-pdf">
   ...
   <table class="table">
      ...
      <tr>
         <td>
            <?php echo !empty($sign_userKT) ? '<img src="'.$sign_userKT.'" alt="" class="sign"><p class="d-block text-center">'.$fullnameUserKT.'</p><p class="d-block text-center">'.getDateFormat($report['create_at'], 'd-m-Y H:i:s').'</p>' : false ?>
         </td>
         <td>
