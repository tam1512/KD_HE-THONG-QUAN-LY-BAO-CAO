...
<div class="<?php echo !empty($actionOld) ? 'container' : 'container-fluid' ?> content-pdf page-break overflow-hidden">
   <table class="table table-bordered table-responsive mb-0 table-responsive">
      <tbody>
         <tr>
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan=2>
               <p style="<?php echo $styleFont; echo $isStyle ? "font-size: 10px" : "margin-bottom: 0 !important"  ?>">
                  Số:
   ...
   <table class="table table-bordered table-responsive mb-0">
      <tbody>
         <tr>
            ...
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> colspan="2" width="100%">
         ...
         <tr>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> rowspan="4" width="30%"
               style="text-align: left; vertical-align: middle;"><b
                  style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px" : ""   ?>">Kết quả
                  AQL</b></td>
            <td <?php echo $isStyle ? 'style="padding: 0.50rem 0.60rem;"' : "" ?> width="50%"><b
      ...
      <tbody>
         ...
         <tr>
            ...
            <?php
               if(empty($actionOld)) {
                  echo '<td><a
               href="'.getLinkAdmin('reports', 'seen_images_defect', ['id'=>$reportId]).'?report_defect_id='.$item['id'].'"
               class="btn btn-success"><i class="far fa-eye"></i></a></td>';
            } else {
            $listDefectImageId[] = ['id'=>$reportId, 'report_defect_id'=>$item['id']];
            }
            ?>
         </tr>
         <?php 
         ...
         <tr>
            ...
            <?php
               if($resultAQL['conclusion'] == 2) {
                  $imgAchieve = "check.png";
               } else {
                  $imgAchieve = "not-check.png";
               }
               if($resultAQL['conclusion'] == 1) {
                  $imgNotAchieve = "check.png";
               } else {
                  $imgNotAchieve = "not-check.png";
               }
               if($resultAQL['conclusion'] == 3) {
                  $imgWait = "check.png";
               } else {
                  $imgWait = "not-check.png";
               }
            ?>
            <td class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px; padding: 0.50rem 0.60rem;" : ""   ?>">
               <img
                  src="<?php echo "data:image/png;base64,".base64_encode(file_get_contents(_WEB_HOST_ROOT_ADMIN."/images/$imgAchieve")) ?>"
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;"
                  class="mr-2 <?php echo $isStyle ? 'mt-2': false ?>">ĐẠT
            </td>
            <td colspan="2" class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px; padding: 0.50rem 0.60rem;" : ""   ?>">
               <img
                  src="<?php echo "data:image/png;base64,".base64_encode(file_get_contents(_WEB_HOST_ROOT_ADMIN."/images/$imgNotAchieve")) ?>"
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;"
                  class="mr-2 <?php echo $isStyle ? 'mt-2': false ?>">KHÔNG
               ĐẠT
            </td>
            <td <?php echo (!empty($actionOld)) ? 'colspan="4"' : 'colspan="3"'; ?> class="text-center"
               style="<?php echo $styleFont; echo $isStyle ? "font-size: 12px; padding: 0.50rem 0.60rem;" : ""   ?>">
               <img
                  src="<?php echo "data:image/png;base64,".base64_encode(file_get_contents(_WEB_HOST_ROOT_ADMIN."/images/$imgWait")) ?>"
                  alt="" style="width:14px; height: 14px; object-fit:cover; margin-right: 3px;"
                  class="mr-2 <?php echo $isStyle ? 'mt-2': false ?>">CHỜ
               XỬ LÝ
            </td>
         </tr>
      </tbody>
   ...
   <div>
      ...
      <input type="hidden" id="id" value="<?php echo $reportId ?>">
      <hr>
   </div>
   <?php 
      endif;
