   ...
   if(!empty($object)) {
      ...
      if($status != 3) {
         if($object != 'all') {
            ...
            $sqlTotalInspect = "SELECT SUM(quantity_inspect) as total_inspect FROM reports AS rp $filter";
