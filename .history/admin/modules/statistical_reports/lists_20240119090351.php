...
<section class="content">
   <div class="container-fluid">
      ...
      <div class="mt-5">
         ...
         <form action="<?php echo getLinkAdmin('statistical_reports', 'export_test') ?>" method="post">
            <input type="hidden" id="dataTableExcel" name="dataTableExcel">
            <button type="submit" class="btn btn-success mb-2" id="exportExcelStatistical"
               name="btnExportExcelStatistical">Xuất Excel</button>
         </form>
