...
$xAxisTitle = new \PhpOffice\PhpSpreadsheet\Chart\Title('Tháng');
$xAxis->setTitle($xAxisTitle);

// Đặt tiêu đề cho trục y
$yAxisTitle = new \PhpOffice\PhpSpreadsheet\Chart\Title('Doanh thu');
$yAxis->setTitle($yAxisTitle);

// Đặt tiêu đề cho trục y2
$yAxisTitle2 = new \PhpOffice\PhpSpreadsheet\Chart\Title('Số lượng');
...
// Lưu tệp Excel
$writer->save('bieu_do_ket_hop.xlsx');