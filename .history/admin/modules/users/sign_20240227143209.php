...
<div class="container-fluid">
   ...
   <form action="" method="POST">
      <div class="row">
         <div class="col-12">
            <div class="form-group">
               <label for="signature">Chữ ký:<span style="color:red">*</span> (<i class="error">Nhớ bấm xác nhận trước
                     khi Lưu</i>)</label>
               <!-- Signature -->
      ...
      <input type="hidden" id="sign-text" value="<?php echo form_infor('sign_text', $infor) ?>">
      <input type="hidden" name="sign_text" value="<?php echo form_infor('sign_text', $infor) ?>">
      <button type="submit" class="btn btn-primary">Lưu chữ ký</a>
   </form>
</div>
<?php
  layout('footer', 'admin');
