...
//  $signText = !empty(first("SELECT sign_text FROM sign WHERE user_id = $userId")['sign_text']) ? first("SELECT sign_text FROM sign WHERE user_id = $userId")['sign_text'] : false;
$signText = first("SELECT sign_text FROM sign WHERE user_id = $userId");
