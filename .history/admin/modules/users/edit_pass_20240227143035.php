...
/**
 * Chứa chức năng chỉnh sửa mật khẩu cũa người dùng đang đăng nhập
 */
if(!isLogin()) {
...
$data = [
 ...
 if(isPost()) {
   ...
   if(empty($password_old)) {
      $errors['password_old']['empty'] = 'Mật khẩu cũ không được để trống';
   } else {
   ...
   if(empty($errors)) {
      ...
      redirect('admin/dang-xuat');
   } else {
      setFlashData('msg', 'Vui lòng kiểm tra dữ liệu nhập vào!');
      setFlashData('msg_type', 'danger');
      setFlashData('errors', $errors);
      redirect("admin/nguoi-dung/doi-mat-khau");
   }
}
            ...
            <div class="row">
               <div class="col">
                  <div class="form-group">
                     <label for="password_old">Mật khẩu cũ<span style="color:red">*</span></label>
