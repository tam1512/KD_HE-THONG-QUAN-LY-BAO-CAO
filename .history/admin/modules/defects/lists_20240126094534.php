   ...
   <div class="container-fluid">
      ...
      <nav aria-label="Page navigation defects"
         ...
         <ul class="pagination pagination-sm justify-content-end">
            ...
            <?php     
               ...
               echo getLink('defects').$queryStr.'page='.$prevPage;
            ?>">
                  Trước
               </a>
            </li>
         ...
         if(!empty($numPage)) {
            ...
            if($numPage <= $limitPagination) {
               for($i = 1; $i <= $numPage; $i++) {
                  if($page == $i) {
                     echo '<li class="page-item active"><a class="page-link" href="'.getLink('defects').$queryStr.'page='.$i.'">'.$i.'</a></li>';
                  } else {
                     echo '<li class="page-item"><a class="page-link" href="'.getLink('defects').$queryStr.'page='.$i.'">'.$i.'</a></li>';
                  }
               }
            } else {
               for($i = $begin; $i <= $end; $i++) {
      ...
      ?>
         ...
         <?php 
            ...
            echo getLink('defects').$queryStr.'page='.$nextPage;
         ?>">
                  Sau
               </a>
            </li>
         ...
         <?php 
               echo getLink('defects').$queryStr.'page='.$numPage;
            ?>">
                  Trang cuối
               </a>
            </li>
