...
$listGroupOnPage = getRaw("SELECT id, name, rôt, create_at FROM groups $filter LIMIT $offset, $groupOnPage");
      ...
      <table class="table table-bordered">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a class="text-center"
                     href="<?php echo getLinkAdmin('groups', 'edit', ['id' => $group['id']]) ?>"><?php echo $group["name"] ?><?php echo $group['root'] == 1 ? '<i class="fa fa-check-circle" aria-hidden="true"></i>' : false ?></a>
               </td>
