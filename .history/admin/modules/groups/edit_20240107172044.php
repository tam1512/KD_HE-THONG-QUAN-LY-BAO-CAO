...
if(isGet()) {
   ...
   if(!empty($groupId)) {
      $defaultGroup = firstRaw("SELECT name, description FROM groups WHERE id = $groupId");
         ...
         <form action="" method="post">
            <div class="row">
               <div class="col">
                  ...
                  <div class="form-group">
                     <label for="description">Phân quyền</label>
                     <input type="text" id="description" name="description" class="form-control"
                        placeholder="Phân quyền..." value="<?php echo old('description', $old) ?>">
