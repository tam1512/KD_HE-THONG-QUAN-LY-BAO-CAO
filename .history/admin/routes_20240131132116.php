<?php 
   ...
   //report_categories
   $route['danh-muc-bien-ban'] = 'index.php?module=report_categories';
   ...
   //reports
   $route['bien-ban'] = 'index.php?module=reports';
   $route['bien-ban/thong-bao'] = 'index.php?module=reports&action=notifications';
   ...
   $route['bien-ban/xem-anh-loi/id=(.+)'] = 'index.php?module=reports&action=seen_images_report_defect&id=$1';
   $route['bien-ban/xem-anh-loi-bien-ban/id=(.+)'] = 'index.php?module=reports&action=seen_images_defect&id=$1';
   $route['bien-ban/xoa-loi-bien-ban/id=(.+)'] = 'index.php?module=reports&action=report_defect_delete&id=$1';
   $route['bien-ban/xem/id=(.+)'] = 'index.php?module=reports&action=seen&id=$1';
   $route['bien-ban/user_id=(.+)'] = 'index.php?module=reports&user_id=$1';
   $route['bien-ban/factory_id=(.+)'] = 'index.php?module=reports&factory_id=$1';
   $route['bien-ban/conclusion=(.+)'] = 'index.php?module=reports&conclusion=$1';
   $route['bien-ban/chi-tiet/id=(.+)'] = 'index.php?module=reports&action=defect_detail&id=$1';
   $route['bien-ban/ky-nhanh/id=(.+)'] = 'index.php?module=reports&action=quick_sign&id=$1';
   $route['bien-ban/xac-nhan-bien-ban/id=(.+)'] = 'index.php?module=reports&action=confirm_report&id=$1';
