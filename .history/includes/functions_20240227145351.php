...
function getLinkAdmin($module, $action = "", $params = []) {
  $moduleArr = [
    ...
    'products' => 'san-pham',
    'report_categories' => 'danh-muc-bao-cao',
    'reports' => 'bao-cao',
  ...
  $actionArr = [
    ...
    'report_defect_delete' => 'xoa-loi-bao-cao',
    'export' => 'xuat-pdf',
    ...
    'quick_sign' => 'ky-nhanh',
    'confirm_report' => 'xac-nhan-bao-cao',
    'seen_images_defect' => 'xem-anh-loi-bao-cao'
  ];
...
function deleteSessionOutReport() {
  ...
  if(!empty($urlArr)) { 
     ...
     if(!empty($urlArr[2])) {
         if(strpos($urlArr[2], 'id') !== false) {
             $idArr = explode("=", $urlArr[2]);
             $id = $idArr[1];
         }
     }
  }
