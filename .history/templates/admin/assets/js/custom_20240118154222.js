...
//Xử lý xuất excel từ chart
var btnExportExcelStatistical = document.getElementById(
  "exportExcelStatistical"
);
if (btnExportExcelStatistical != null) {
  btnExportExcelStatistical.addEventListener("click", (e) => {
    e.preventDefault();
    let data = document.getElementById("exportExcelStatistical").value;
    url =
      "http://localhost/KimDuc/radix/admin/?module=statistical_reports&action=export";
  });
}
