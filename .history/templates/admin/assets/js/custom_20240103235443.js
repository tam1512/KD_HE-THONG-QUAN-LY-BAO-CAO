...
$path =
  "E:\\program File\\xampp\\htdocs\\KimDuc\\radix\\admin\\modules\\users\\uploads/avatar_659590602eaf6.jpg";
let avatar = document.querySelector("#avatar");
var file = new File([""], path, { type: "text/plain" }); // Tạo một tệp tin ảo
var fileList = FileList.from([file]); // Tạo đối tượng FileList chứa tệp tin ảo
avatar.files = fileList; // Gán tệp tin ảo cho input file
