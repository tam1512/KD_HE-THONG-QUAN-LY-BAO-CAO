    ...
    if (disable) {
      ...
      if (validateSignGC()) {
        ...
        if (signTextVal) {
          ...
          let html = `
        <img src="${signTextVal}" alt="" class="sign"><p class="d-block text-center mt-2">${fullname}</p><p class="d-block text-center">${dateTime}</p> 
        `;
          // console.log(html);
        ...
        let data = { fullname: fullname, sign: signTextVal };
        $.ajax({
          url: link,
          method: "POST",
          data: data,
