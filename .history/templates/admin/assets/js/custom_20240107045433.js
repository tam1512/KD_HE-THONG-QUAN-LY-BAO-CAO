  ...
  $("#disable_GC").click(function (e) {
    ...
    if (validateSignGC()) {
      ...
      if (signTextVal) {
        ...
        let html = `
        <img src="${signValue}" alt="" class="sign"><p class="d-block text-center mt-2">${fullname}</p><p class="d-block text-center">${dateTime}</p> 
        `;
        document.getElementById("sign_GC").innerHTML = html;
      }
